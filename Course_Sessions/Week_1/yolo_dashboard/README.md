...
| **Live controls** | Confidence, IoU, image size, device, and per-class filtering |
...
> **No conda?** Any Python 3.10+ environment works — replace step 1 with your
...
- **Image upload** / **Video upload** — drop in your own files. Video is
...
Pick **Compare two models** in the sidebar, choose **Model A** and **Model B**,
