...
- [Data Preprocessing Guide](DATA_PREPROCESSING_GUIDE.md) -- detailed preprocessing reference
- [Model Evaluation Guide](MODEL_EVALUATION_GUIDE.md) -- all metrics and tuning methods
- [ML Debugging Guide](ML_DEBUGGING_GUIDE.md) -- troubleshooting when things go wrong
- [Python Essentials Guide](PYTHON_ESSENTIALS_FOR_ML.md) -- Python and library basics
